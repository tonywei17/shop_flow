    ...
    <div className="p-8">
      ...
      <div className="grid lg:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-white rounded-lg border p-6">
          <h3 className="text-lg font-bold mb-4">収入推移（過去6ヶ月）</h3>
        ...
        {/* Member Growth */}
        <div className="bg-white rounded-lg border p-6">
          <h3 className="text-lg font-bold mb-4">会員数推移</h3>
          <div className="h-64 flex items-end justify-between gap-2">
            {[
              ...
              const maxTotal = 1300;
              const premiumHeight = (data.premium / maxTotal) * 100;
              const freeHeight = (data.free / maxTotal) * 100;
              return (
                <div key={i} className="flex-1 flex flex-col items-center gap-2">
      ...
      <div className="grid lg:grid-cols-3 gap-6 mb-6">
        {/* Revenue Sources */}
        <div className="bg-white rounded-lg border p-6">
          <h3 className="text-lg font-bold mb-4">収入源別内訳</h3>
        ...
        {/* Top Courses */}
        <div className="bg-white rounded-lg border p-6">
          <h3 className="text-lg font-bold mb-4">人気コースTOP5</h3>
      ...
      {/* Activity Stats */}
      <div className="bg-white rounded-lg border p-6">
        <h3 className="text-lg font-bold mb-4">活動・研修参加状況</h3>
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-2">
        ...
        <span className="text-sm font-bold">{obtained}名</span>
      </div>
