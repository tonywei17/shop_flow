...
const mockData: InvoicePDFData = {
  ...
  details: {
    ccMembers: [
      { className: "北海道認定教室", classroomCode: "1110001", count: 2, unitPrice: 480, amount: 960, deliveryDate: "001", invoiceAmount: 960, deductionAmount: 0, isAigran: false, rebateAmount: 0, isBankTransfer: false },
      { className: "北海道認定教室", classroomCode: "1110002", count: 2, unitPrice: 480, amount: 960, deliveryDate: "002", invoiceAmount: 960, deductionAmount: 0, isAigran: false, rebateAmount: 0, isBankTransfer: false },
    ],
    materials: [
      { date: "04/24", slipNumber: "40377", productName: "リトミックセット５", unitPrice: 2500, quantity: 1, amount: 2500, deliveryTo: "00", invoiceAmount: 2500, deductionAmount: 0 },
    ],
    otherExpenses: [],
  },
};
